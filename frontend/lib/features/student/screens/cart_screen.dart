...
class _CartScreenState extends ConsumerState<CartScreen> {
  ...
  int get _discount {
    ...
    if (_promoApplied!.toUpperCase() == 'CAMPUS10')
      return (cart.subtotal * 0.10).round();
  ...
  void _applyPromo() {
    ...
    if (code == 'CAMPUS10' || code == 'IUB5') {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text('Invalid code: $code — try CAMPUS10 or IUB5'),
          behavior: SnackBarBehavior.floating));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final suggestionsAsync = cart.vendorId == null
        ? null
    ...
    return Scaffold(
      ...
      appBar: AppTopBar(
        ...
        subtitle: cart.isEmpty
            ? 'Add something tasty'
            : '${cart.lines.values.fold(0, (s, l) => s + l.qty)} items • ${cart.lines.length} dishes',
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          _TipRow(
                              ...
                              text: 'Search vendors from the home screen'),
                          _TipRow(
                              icon: Icons.favorite_border_rounded,
                              text: 'Save favorite vendors & dishes'),
                          _TipRow(
                              icon: Icons.bolt_rounded,
                              text: 'Order before 12:30 to skip rush'),
                        ]),
                  ),
                ])
              : ListView(
          ...
          Container(
            ...
            child: SafeArea(
              child: Column(children: [
                ...
                PrimaryButton(
                    label: 'Proceed to checkout • ${taka(cartTotal)}',
                        ...
                        children: [
                          Text('Total',
                              style: TextStyle(
                                  color: AppColors.textPrimary,
                                  fontWeight: FontWeight.w700)),
                          PriceText(cart.subtotal + 5, fontSize: 18)
                        ]),
                  ]),
            ),
            SizedBox(height: 12),
              ...
              child: Row(children: [
                ...
                Expanded(
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                      Text('Server-computed totals',
                          style: TextStyle(
                              color: AppColors.textPrimary,
                              fontWeight: FontWeight.w600,
                              fontSize: 12)),
                      Text('Client prices are never trusted',
                          style: TextStyle(
