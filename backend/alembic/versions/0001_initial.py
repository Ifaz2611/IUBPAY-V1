...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("PENDING", "APPROVED", "SUSPENDED", name="vendorstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "vendor_id", sa.String(32), sa.ForeignKey("vendors.id", use_alter=True), nullable=True
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now()),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(32), primary_key=True),
        sa.Column(
            "vendor_id", sa.String(32), sa.ForeignKey("vendors.id"), index=True, nullable=False
        ),
        ...
        sa.Column(
            "category",
            sa.Enum("MEAL", "SNACK", "BEVERAGE", "OTHER", name="itemcategory"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "student_id", sa.String(32), sa.ForeignKey("users.id"), index=True, nullable=False
        ),
        sa.Column(
            "vendor_id", sa.String(32), sa.ForeignKey("vendors.id"), index=True, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(32), primary_key=True),
        sa.Column(
            "order_id", sa.String(32), sa.ForeignKey("orders.id"), index=True, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("CREATED", "PROCESSING", "SUCCEEDED", "FAILED", name="paymentstatus"),
            index=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(32), primary_key=True),
        sa.Column(
            "payment_id", sa.String(32), sa.ForeignKey("payments.id"), index=True, nullable=False
        ),
        sa.Column("amount_taka", sa.Integer(), nullable=False),
        sa.Column("reason", sa.String(255), nullable=True),
        sa.Column(
            "status",
            sa.Enum("REFUND_PENDING", "REFUNDED", "FAILED", name="refundstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "entry_type",
            sa.Enum("PAYMENT", "REFUND", "FEE", "ADJUSTMENT", name="ledgerentrytype"),
            nullable=False,
        ),
        sa.Column("amount_taka", sa.Integer(), nullable=False),
